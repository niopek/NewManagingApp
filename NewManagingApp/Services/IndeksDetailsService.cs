...
{
    public async static void SaveListToExcelPlatform(this ObservableCollection<IndeksDetails> list)
    {
    ...
    private async static Task<bool> PlatformSavingModel(string path, ObservableCollection<IndeksDetails> list)
    {
        bool test = false;
        await Task.Run(() =>
        {
    ...
    public async static void SaveListToExcelAsPriceList(this ObservableCollection<IndeksDetails> list)
    {
        string path = PathService.GetPath();
    ...
    private async static Task<bool> PriceListSavingModel(string path, ObservableCollection<IndeksDetails> list)
    {
        bool test = false;
        await Task.Run(() =>
        {
