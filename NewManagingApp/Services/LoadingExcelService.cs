...
internal static class LoadingExcelService
{
    ...
    public static async Task<ObservableCollection<Indeks>> DataTableToListOfBaseIndeks(DataTable dataTable)
    {
        ...
        {
            MessageBox.Show("Błedny format raportu, poprawny: pkuiw, indeks, nazwa, opis, jm, grupa mat, klwyc, tc");
        }
    ...
    public static async Task<ObservableCollection<Order>> DataTableToListOfOrders(DataTable dataTable)
    {
        ...
        {
            MessageBox.Show("Błedny format raportu, poprawny: nr zam, indeks, nazwa, opis, nr dost, nazwa dost, ilość, jedn.miary, suma zam, waluta, data, zaklad, pkuiw, ruch mat, rodz mat, tc");
        }
